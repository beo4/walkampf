		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<dl>
					...
					<g:if test="${partyInstance?.color}">
						<dt><g:message code="party.color.label" default="Color" /></dt>
						
							<dd><g:fieldValue bean="${partyInstance}" field="color"/></dd>
					...
					<g:if test="${partyInstance?.shortname}">
						<dt><g:message code="party.shortname.label" default="Shortname" /></dt>
						
							<dd><g:fieldValue bean="${partyInstance}" field="shortname"/></dd>
